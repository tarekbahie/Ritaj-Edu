...
class DataService{
    ...
    func getStudentsUpdatedData(comp :@escaping (_ names : [String],_ ages : [String],_ schoolNames : [String],_ schoolGrades : [String],_ sat1Subs : [String],_ sat2Subs : [String],_ emails : [String])->()){
        var n = [String]()
        var a = [String]()
        var sN = [String]()
        var sG = [String]()
        ...
        db.collection("Students").getDocuments { (querySnapshot, err) in
            if let error = err{
                ...
                comp(n,a,sN,sG,s1Subs,s2Subs,e)
            }
        }
    }
    func sendStudentUpdatedData(fN:String,a:String,sN:String,sG:String,sat1:String,sat2:String,email:String,comp : @escaping(_ success : Bool, _ errMsg:String?)->()){
